...
import { LoaderCircle, Mail, Lock } from "lucide-react" // 引入图标
            ...
            <div className="relative flex min-h-screen items-center justify-center">
                ...
                <FadeIn delay={0.1} className="w-full max-w-md">
                    <Card className="w-full overflow-hidden">
                        <CardHeader className="relative h-[100px] flex flex-col items-center justify-center text-center">
                            ...
                            <motion.p
                                ...
                                className={cn(
                                    "text-3xl font-bold text-foreground m-0 text-center",
                        ...
                        <CardContent>
                            ...
                            >
                                ...
                                <div className="space-y-2">
                                    ...
                                    {/* 密码强度指示器 - 仅在注册时显示，使用固定高度容器避免布局抖动 */}
                                    <div className="h-[36px] overflow-hidden">
                                        <AnimatePresence>
                                            {hoverState === 'signup' && passwordValue && (
                                                <motion.div
